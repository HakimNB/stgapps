...
//    }
    ...
    public void GetJsonAPIRequest(final String szApiEndpoint, final String szPayload, final OnApiCallback callback) {
        if ( m_requestQueue == null ) {
            if ( callback != null ) {
        ...
        LogManager.Debug(this.getClass().getName(), "GetJsonAPIRequest URL: " + szUrl);
        LogManager.Debug(this.getClass().getName(), "GetJsonAPIRequest Payload: " + szPayload);
        StringRequest request = new StringRequest(Request.Method.GET, szUrl, new Response.Listener<String>() {
            @Override
